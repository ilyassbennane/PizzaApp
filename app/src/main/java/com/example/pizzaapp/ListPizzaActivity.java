...
public class ListPizzaActivity extends AppCompatActivity {
    ...
    String nomitem ;
    String detaisingreditem ;
    String descriptionitem ;
    String preparationitem ;
    ...
    TextView nomm ;
    TextView idd;
    //EditText detaisingredd ;
    //EditText descriptionn ;
    //EditText preparationn ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fs.create(new Produit("LOADED MEXICAN PIZZA",
                3,R.mipmap.pizza7,
                30,
        ...
        fs.create(new Produit("BACON CHEESEBURGER PIZZA",
                2,R.mipmap.pizza8,
                20,
        ...
        fs.create(new Produit("PIZZA MARGHERITA",
                1,R.mipmap.pizza9,
                30 ,
        ...
        fs.create(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA",
                5,R.mipmap.pizza10,
                45 ,
        ...
        list.setAdapter(new PizzaAdapter(fs.findAll(), ListPizzaActivity.this ));
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String nomitem = fs.findById(id3).getNom();
                String ingreditem = fs.findById(id3).getDetaisIngred();
                String descriptionitem = fs.findById(id3).getDescription();
                String preparationitem = fs.findById(id3).getPreparation();
                int imageitem = fs.findById(id3).getPhoto();
                Intent intent = new Intent(ListPizzaActivity.this, DescriptionActivity.class);

                intent.putExtra(DescriptionActivity.NOM,nomitem);
                intent.putExtra(DescriptionActivity.DETAISINGRED,ingreditem);
                intent.putExtra(DescriptionActivity.DESCRIPTION,descriptionitem);
                intent.putExtra(DescriptionActivity.PREPARATION,preparationitem);
                intent.putExtra(DescriptionActivity.IMAGE, imageitem);
